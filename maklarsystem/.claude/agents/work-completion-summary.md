...
tools: mcp__ElevenLabs__text_to_speech, mcp__ElevenLabs__play_audio, Glob, Grep, LS, Read, NotebookRead, WebFetch, TodoWrite, WebSearch, ListMcpResourcesTool, ReadMcpResourceTool
color: Green
---
...
USER_NAME: "Rani"
LANGUAGE: "Swedish" # Can be "Swedish" or "English"
...
2. IMPORTANT: **Create ultra-concise summary**: Craft a concise 1 sentence maximum summary of what was done (no introductions, no filler) - use Swedish if LANGUAGE is set to "Swedish"
3. **Suggest next steps**: Add concise 1 logical next actions in equally concise format - in the same language as the summary
4. **Generate audio**:
